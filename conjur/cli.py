...
'''
    ...
    def handle_variable_logic(cls, ssl_verify=True, args=None, client=None):
        ...
        if args.action == 'get':
            variable_data = VariableData(action=args.action, id=args.id, value=None, variable_version=args.version)
            ...
            variable_data = VariableData(action=args.action, id=args.id, value=args.value, variable_version=None)
            variable_controller = VariableController(ssl_verify=ssl_verify,
                                                     variable_logic=variable_logic,
                                                     variable_data=variable_data)
