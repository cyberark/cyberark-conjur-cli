...
class CliIntegrationTest(unittest.TestCase):
    ...
    cli_auth_params = ['--debug']
    for required_env_var, param_name in REQUIRED_ENV_VARS.items():
        cli_auth_params += ['--{}'.format(param_name), os.environ[required_env_var]]
    ...
    def setUp(self):
        ...
        set_params = CliIntegrationTest.cli_auth_params + \
