...
class CliIntegrationListTest(IntegrationTestCaseBase):  # pragma: no cover
    ...
    def setUp(self):
        self.params = self.setup_cli_params({})
    ...
    # TODO This will need to be changed when UX is included
    @integration_test
    ...
    def test_list_random_input_raises_error(self):
        ...
        self.assertIn("Error unrecognized arguments", self.capture_stream.getvalue())
