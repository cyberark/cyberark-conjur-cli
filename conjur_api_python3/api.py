...
class Api(object):
    ...
    def login(self, login_id=None, password=None):
        ...
        return self._invoke_endpoint(HttpVerb.GET, url, auth=HTTPBasicAuth(login_id, password)).text
    ...
    def authenticate(self, login_id=None, api_key=None):
        ...
        print("Authenticating to {}...".format(url))
        return self._invoke_endpoint(HttpVerb.POST, url, api_key).text
    ...
    def _invoke_endpoint(self, verb_id, url, *args, check_errors=True, auth=None, api_token=None):
        headers={}
